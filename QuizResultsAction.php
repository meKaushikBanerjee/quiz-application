...
if($nonull==0)
{
	...
	if($query->rowCount() > 0)
	{
		foreach($results as $result)
		{
			...
			$sql="INSERT INTO quizresult(U_NAME,U_PNO,QUIZ_ID,QUIZ_NAME,SUBMIT_TIME,U_MARKS,REGION) VALUES(:u_name,:u_pno,:qid,:quizname,:timetaken,:marks,:u_grp)";
			$query = $dbh->prepare($sql);
